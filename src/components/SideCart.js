                                ...
                                <div className="px-[20px]">
                                    ...
                                    <div className="flex items-end">
                                        <div className='flex items-center bg-[#f1f1f1] rounded-[3px] mt-[10px]'>
                                            ...
                                            <input className="py-[4px] w-[40px] text-center bg-[#f1f1f1]" type="text" value={item.quantity} />
                                            <button className="py-[4px] px-[12px] text-[19px]" onClick={()=>updateItemQuantity(item.id, item.quantity+1)}>+</button>
                                        </div>
                        ...
                        <div className={`absolute z-[20] w-full bottom-0 translate-y-[100%] transition duration-[500ms] ease-in-out px-[24px] pt-[16px] pb-[64px] bg-white ${transform.shipping}`} style={{boxShadow:'0 0 10px #82828233'}}>
                            ...
                            <form>
                                <div className="mb-[24px] ">
                                    ...
                                    <select name="" id="" className="mt-[0.25rem] mb-[10px] px-[12px] py-[12px] w-full border border-[#dbdbdb] rounded-[5px] outline-0 transition-[border] duration-400 ease-in-out focus:border-[#bd8c27]">
                                        <option value="">France</option>
                                    </select>
                                </div>
                                <div className="mb-[24px] ">
                                    <label htmlFor="">Postal code</label>
                                    <input type="text" name="" id="" className="mt-[0.25rem] mb-[10px] px-[12px] py-[10px] w-full border border-[#dbdbdb] rounded-[5px] outline-0 transition-[border] duration-400 ease-in-out focus:border-[#bd8c27]"/>
                                </div>
                                <div className="flex flex-col">
