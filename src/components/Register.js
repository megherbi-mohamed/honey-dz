            ...
            <div className="py-[64px]">
                <div className="w-[90%] md:w-[34%] mx-auto">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <button type="submit" className="mt-[16px] mb-[12px] px-[32px] py-[10px] bg-[#bd8c27] text-white text-sm block w-full rounded-[5px] transition-[outline] duration-600 ease-in-out outline outline-0 outline-[#bd8c27] hover:outline-[3px]">Register</button>
                    </form>
